...
var sql1="SELECT * FROM zr_product WHERE pid=?";//用pid查当前商品信息
var sql2="SELECT * FROM zr_product_pic WHERE pid=?";//用pid查当前商品图片列表
var sql3="SELECT pid,color FROM zr_product WHERE cid=(SELECT cid FROM zr_product where pid=?)";//用pid查当前商品同系列的规格列表
